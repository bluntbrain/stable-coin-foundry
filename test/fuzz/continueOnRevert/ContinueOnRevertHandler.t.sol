...
/// @title ContinueOnRevert Handler for DSCEngine Invariant Tests
/// @author Ishan Lakhwani
/// @notice Handles fuzz test interactions with DSCEngine while continuing on reverts
/// @dev Used in conjunction with ContinueOnRevertInvariants.t.sol
...
/// @notice Handler contract for fuzzing DSCEngine operations
contract ContinueOnRevertHandler is Test {
    ...
    /// @notice Sets up the handler with required contract instances
    /// @param _dscEngine The DSCEngine contract to test
    /// @param _dsc The DecentralizedStableCoin contract to test
